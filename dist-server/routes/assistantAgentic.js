...
import { getOrCreateAssistant, createThread, addMessage, uploadFile, runAssistant } from '../services/assistantService.js';
const router = Router();
...
router.post('/thread', asyncHandler(async (req, res) => {
...
router.post('/message', upload.single('file'), asyncHandler(async (req, res) => {
...
router.delete('/thread/:threadId', asyncHandler(async (req, res) => {
