...
export const mockOpportunities = [
  ...
  { id: 3, name: 'BuildCo - Expansion', account: 'BuildCo Ltd', contact: 'Bob Johnson', amount: 2500000, stage: 'Proposal/Price Quote', closeDate: '2024-04-10', owner: 'Sarah Johnson', probability: 60, email: 'bob@buildco.com', phone: '555-0102' },
  { id: 4, name: 'DataFlow Implementation', account: 'DataFlow Inc', contact: 'Alice Brown', amount: 7500000, stage: 'Negotiation/Review', closeDate: '2024-02-20', owner: 'John Williams', probability: 75, email: 'alice@dataflow.com', phone: '555-0103' },
  { id: 5, name: 'CloudNine Solutions', account: 'CloudNine Corp', contact: 'Mike Wilson', amount: 4000000, stage: 'Closed Won', closeDate: '2024-01-30', owner: 'Sarah Johnson', probability: 100, email: 'mike@cloudnine.com', phone: '555-0104' },
];
...
export const mockInvoices = [
  { id: 'INV-001', account: 'Acme Corporation', contact: 'John Doe', amount: 5000000, status: 'paid', issueDate: '2024-01-15', dueDate: '2024-02-15', paidDate: '2024-02-10', items: [{ description: 'Enterprise Package - Annual License', quantity: 1, rate: 5000000 }], notes: 'Payment received via wire transfer' },
  { id: 'INV-002', account: 'TechStart Inc', contact: 'Jane Smith', amount: 1500000, status: 'sent', issueDate: '2024-02-01', dueDate: '2024-03-01', paidDate: null, items: [{ description: 'SMB Package - Q1 Services', quantity: 1, rate: 1500000 }], notes: 'Invoice sent via email on 2024-02-01' },
  { id: 'INV-003', account: 'BuildCo Ltd', contact: 'Bob Johnson', amount: 2500000, status: 'overdue', issueDate: '2024-01-10', dueDate: '2024-02-10', paidDate: null, items: [{ description: 'Expansion Services', quantity: 1, rate: 2500000 }], notes: 'Follow-up required - overdue by 1 day' },
  { id: 'INV-004', account: 'DataFlow Inc', contact: 'Alice Brown', amount: 7500000, status: 'sent', issueDate: '2024-02-05', dueDate: '2024-03-05', paidDate: null, items: [{ description: 'Implementation Services', quantity: 1, rate: 6000000 }, { description: 'Training & Support', quantity: 1, rate: 1500000 }], notes: 'Awaiting approval from CFO' },
  { id: 'INV-005', account: 'CloudNine Corp', contact: 'Mike Wilson', amount: 4000000, status: 'paid', issueDate: '2024-01-20', dueDate: '2024-02-20', paidDate: '2024-02-18', items: [{ description: 'Cloud Solutions Package', quantity: 1, rate: 4000000 }], notes: 'Paid on time' },
  { id: 'INV-006', account: 'RetailMax', contact: 'Tom Anderson', amount: 1200000, status: 'draft', issueDate: '2024-02-11', dueDate: '2024-03-11', paidDate: null, items: [{ description: 'Retail Integration Services', quantity: 1, rate: 1200000 }], notes: 'Draft - pending client review' },
  { id: 'INV-007', account: 'FinanceHub', contact: 'Emily White', amount: 8500000, status: 'sent', issueDate: '2024-02-08', dueDate: '2024-03-08', paidDate: null, items: [{ description: 'Financial Platform Integration', quantity: 1, rate: 7000000 }, { description: 'Compliance Audit', quantity: 1, rate: 1500000 }], notes: 'Sent to procurement department' },
  { id: 'INV-008', account: 'Acme Corporation', contact: 'Sarah Davis', amount: 3000000, status: 'overdue', issueDate: '2024-01-05', dueDate: '2024-02-05', paidDate: null, items: [{ description: 'Consulting Services - January', quantity: 1, rate: 3000000 }], notes: 'Multiple follow-up attempts made' },
];
